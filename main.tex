...
process handles uncertain that is difficult to reason about using models with different levels of aggregation where each actors understands
how to exploit his model to the fullest. As the uncertainties manifest themselves the actors/models handle the uncertainty through 
